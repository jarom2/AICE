...
with np.errstate(invalid='ignore'):
    ...
    title_name = 'Actual vs Predicted Solar Generation (Avg, RF Training) Corr: {}'.format(correlation[0])
    ...
    title_name2 = "Actual vs Predicted Solar Generation (Avg, RF Test) Corr: {}".format(correlation2[0])
